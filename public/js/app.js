...
__webpack_require__(/*! ../vendor/calendar/js/datepicker */ "./resources/vendor/calendar/js/datepicker.js");
  ...
  if ($("#tasks").length) {
    ...
    $(".duplicate-next").click(function () {
      ...
      for (var i = columnIndex; i < columnCount; i++) {
        $("#tasks").find("tbody tr").each(function () {
          var val = $(this).find("td").eq(columnIndex).find("select").val();
          $(this).find("td").eq(i).find("select").val(val).trigger("change");
        });
      }
    });
    $("#tasks-save").click(function () {
      ...
      $("#tasks").find("select").each(function () {
        if ($(this).val().length) {
          json.push({
            user_id: $(this).val(),
            date: $(this).data("day")
...
/***/ "./resources/vendor/calendar/js/datepicker.js":
/*!****************************************************!*\
  !*** ./resources/vendor/calendar/js/datepicker.js ***!
  \****************************************************/
/***/ (() => {
